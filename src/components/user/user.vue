<template>
  <div id="user">
    <div class="userTit">个人中心</div>
    <div>
      <!-- <div>当前用户：151233232121</div> -->
      <ul>
        <li><img src="../../assets/img/out.png"><span>支出明细</span></li>
        <li><img src="../../assets/img/into.png"><span>收入明细</span></li>
        <li>
            <div><img src="../../assets/img/statistics.png"><span>周统计</span></div>
            <div id="week" :style="{width: '100%', height: '300px'}"></div>
        </li>
        <li>
            <div><img src="../../assets/img/statistics.png"><span>月统计</span></div>
